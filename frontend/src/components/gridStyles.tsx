...
/**
 * Inline loading spinner. Matches the markup already repeated across the grids
 * and dialogs so a fetch-in-progress reads the same everywhere.
 */
export function Spinner({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={`${className} animate-spin text-att-500`} viewBox="0 0 24 24" fill="none" aria-hidden="true">
