"""
Shared pytest fixtures for unit/application tests.

Uses create_engine_from_url so SQLite FK enforcement, WAL mode, and
busy-timeout pragmas are applied on every connection — same as production.
"""
...
import migration_intake.persistence.models_evidence  # noqa: F401  — WaveUtilRow, WaveUtilRevision
